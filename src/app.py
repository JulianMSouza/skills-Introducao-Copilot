...
activities = {
    ...
    "Basketball Team": {
        "description": "Train and play basketball matches with the school team",
        "schedule": "Tuesdays and Fridays, 5:00 PM - 6:30 PM",
        "max_participants": 15,
        "participants": []
    },
    "Volleyball Club": {
        "description": "Practice volleyball and participate in friendly games",
    ...
    "Science Club": {
        "description": "Explore science experiments and prepare for science fairs",
